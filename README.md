...
1. Pick the theme: [Allure-Night.css](./Allure-Night.css), copy the content of it and paste it into the new note created above:
...
## Enable Allure Theme
1. Go to Menu > Options > Appereance, and select `Allure-Night` as your new theme
